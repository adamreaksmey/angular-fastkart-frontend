...
export class SeoService {
    ...
    if (path.includes("product")) {
      if (this.product) {
        this.scoContent = {
          ...
          og_title:
            this.product.meta_title || this.themeOption?.seo?.meta_title,
          og_description:
      ...
      if (this.category) {
        this.scoContent = {
          ...
          url: window.location.href,
          og_title:
            this.category?.meta_title || this.themeOption?.seo?.meta_title,
          og_description:
  ...
  updateDefaultSeo() {
    this.meta.updateTag({
      name: "title",
      content: this.themeOption?.seo?.meta_title,
    });
    this.meta.updateTag({
      name: "description",
    ...
    this.meta.updateTag({
      property: "og:image",
      content: this.scoContent["og_image"],
    });
    ...
    if (
      this.themeOption?.general &&
      this.themeOption?.general?.exit_tagline_enable
    ) {
        ...
        this.ngZone.run(() => {
          ...
          if (this.isTabInFocus) {
            ...
            return this.titleService.setTitle(
              this.themeOption?.general?.site_title &&
                this.themeOption?.general?.site_tagline
