...
import {
  QnAModel,
  QuestionAnswers,
} from "../interface/questions-answers.interface";
...
export class QuestionsAnswersService {
  ...
  getQuestionAnswers(slug: Params): Observable<QnAModel> {
    return this.http.get<QnAModel>(`${environment.URL}/question-and-answer`, {
      params: slug,
    });
  }

  sendQuestion(payload: Params): Observable<QuestionAnswers> {
    return this.http.post<QuestionAnswers>(
      `${environment.URL}/question-and-answer`,
      payload,
    );
  }
  ...
  updateQuestionAnswers(
    ...
    return this.http.put<QuestionAnswers>(
      `${environment.URL}/question-and-answer/${id}`,
      payload,
    );
  }
